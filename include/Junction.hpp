...
class Junction {
    ...
    public:
        Junction(Segment * aSource, Segment * aTarget, char aSourceDir, char aTargetDir, double aCoverage, double aCredibility, bool aInferred = false, bool aIsSourceSinkJunction = false);
        ~Junction();
