...
Junction::Junction(Segment * aSource, Segment * aTarget, char aSourceDir, char aTargetDir, double aCoverage, double aCredibility, bool aInferred, bool aIsSourceSinkJunction) {
...
void Junction::checkLowerBound() { mHasLowerBoundLimit = mWeight->getCopyNum() >= 1; }
